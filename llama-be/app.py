...
def getLlama():
    ...
    food_mapping = ['🍕 - Pizza', '🍔 - Hamburger', '🍟 - French Fries', '🍣 - Sushi', '🍦 - Ice Cream', '🍓 - Strawberry', '🍝 - Spaghetti', '🍛 - Curry Rice', '🍤 - Shrimp', '🍩 - Doughnut', '🍪 - Cookie', '🍫 - Chocolate', '🍬 - Candy', '🍯 - Honey', '🍍 - Pineapple', '🥑 - Avocado', '🥖 - Baguette', '🧀 - Cheese', '🍇 - Grapes', '🍉 - Watermelon', '🍊 - Tangerine', '🍋 - Lemon', '🍌 - Banana', '🍎 - Apple', '🍐 - Pear', '🍑 - Peach', '🍒 - Cherries', '🥕 - Carrot', '🥦 - Broccoli', '🍄 - Mushroom', '🍅 - Tomato', '🥔 - Potato', '🥓 - Bacon', '🥞 - Pancakes', '🍽️ - Plated Fork and Knife', '🥢 - Chopsticks', '🌮 - Taco', '🌯 - Burrito', '🍖 - Meat', '🥩 - Steak', '🍗 - Chicken Leg', '🍲 - Pot of Food', '🥗 - Salad', '🎂 - Cake', '🧁 - Cupcake', '🥧 - Pie', '🥭 - Mango', '🍆 - Eggplant', '🥒 - Cucumber', '🌽 - Corn', '🥜 - Peanuts', '🌰 - Chestnut', '🍞 - Bread', '🥐 - Croissant', '🧇 - Waffle', '🌭 - Hot Dog', '🥪 - Sandwich', '🥟 - Dumpling', '🥨 - Pretzel', '🥯 - Bagel', '🍴 - Fork and Knife', '🧂 - Salt']
    ...
    result = client.predict(
        ...
        "Generate Recipe\n" + \
        "Ingredients - ",
        1972,	# int | float (numeric value between 1 and 2048) in 'Max new tokens' Slider component
